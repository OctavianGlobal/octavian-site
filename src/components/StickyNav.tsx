...
export default function StickyNav() {
  ...
  return (
    <div style={{
      ...
      backdropFilter: "blur(8px)", transition: "border-color 0.25s",
    }}>
      <div className="container" style={{ display: "flex", alignItems: "center", padding: "10px 0" }}>
        ...
        <div style={{ position: "relative" }} data-menu>
          <button
            ...
            style={{
              ...
              color: "#D4AF37", cursor: "pointer", padding: "6px 10px",
                ...
                <>
                  {displayName ? (
                    <>
                      ...
                      <div style={{
                        display: "flex", alignItems: "center", gap: "10px",
                        padding: "14px 18px", borderBottom: "1px solid rgba(212,175,55,0.12)",
                      }}>
                        <div style={{
                          width: "34px", height: "34px", borderRadius: "50%",
                          background: "rgba(212,175,55,0.15)", border: "1px solid rgba(212,175,55,0.4)",
                          display: "flex", alignItems: "center", justifyContent: "center",
                          fontFamily: "Cinzel, serif", fontSize: "14px", color: "#D4AF37", flexShrink: 0,
                        }}>
                          {initial}
                        </div>
                        <div style={{ overflow: "hidden" }}>
                          <div style={{ fontFamily: "var(--font-jakarta), sans-serif", fontSize: "13px", color: "rgba(255,255,255,0.8)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {displayName}
                          </div>
                          {userEmail && (
                            <div style={{ fontFamily: "var(--font-jakarta), sans-serif", fontSize: "11px", color: "rgba(255,255,255,0.35)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                              {userEmail}
                            </div>
                          )}
                        </div>
                      ...
                      {(isAdmin || isEditor) && (
                        <>
                          <div style={{
                            padding: "8px 18px 4px", fontSize: "10px", letterSpacing: "0.18em",
                            textTransform: "uppercase", color: "rgba(212,175,55,0.45)",
                            borderTop: "1px solid rgba(212,175,55,0.12)", marginTop: "4px",
                      ...
                      <button
                        ...
                        style={{
                          ...
                          cursor: "pointer", borderTop: "1px solid rgba(212,175,55,0.12)",
                          borderBottom: "none", borderLeft: "none", borderRight: "none",
                          color: "rgba(255,255,255,0.5)", fontFamily: "var(--font-jakarta), sans-serif",
                          fontSize: "13px", letterSpacing: "0.08em", transition: "background 0.15s",
                        }}
                      >
                        Sign Out
                      </button>
...
function NavLink({ href, label, pathname, hovered, setHovered, onClose }: {
  href: string; label: string; pathname: string;
  hovered: string | null; setHovered: (v: string | null) => void; onClose: () => void;
}) {
  ...
  return (
    <Link
      ...
      style={{
        ...
        letterSpacing: "0.08em", color: active ? "#D4AF37" : "rgba(255,255,255,0.8)",
        textDecoration: "none", borderBottom: "1px solid rgba(212,175,55,0.08)",
        background: isHovered ? "rgba(212,175,55,0.08)" : "transparent", transition: "background 0.15s",
      }}
    >
      {label}
    </Link>
